...
export default (orchestrator: Orchestrator<any>) => 
  orchestrator.registerScenario("zome_01 tests", async (s, t) => {
    ...
    const alice = alice_happ.cells.find(cell => cell.cellNick.includes('/dna_01.dna')) as Cell;
    const bob = bob_happ.cells.find(cell => cell.cellNick.includes('/dna_01.dna')) as Cell;
