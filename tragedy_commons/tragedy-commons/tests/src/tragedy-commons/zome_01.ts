...
export default (orchestrator: Orchestrator<any>) => 
  orchestrator.registerScenario("zome_01 tests", async (s, t) => {
    ...
    const alice = alice_happ.cells.find(cell => cell.cellNick.includes('/tragedy-commons.dna')) as Cell;
    const bob = bob_happ.cells.find(cell => cell.cellNick.includes('/tragedy-commons.dna')) as Cell;
    ...
    const post = await bob.call("zome_01", "get_post", postHash);
