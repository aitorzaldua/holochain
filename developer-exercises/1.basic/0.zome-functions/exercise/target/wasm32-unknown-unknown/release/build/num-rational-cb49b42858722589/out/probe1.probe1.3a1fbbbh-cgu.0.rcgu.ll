...
define hidden void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h68f077aff5323261E"(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>"* noalias nocapture sret(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>") dereferenceable(12) %0, { i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #0 {
start:
...
bb3:                                              ; preds = %bb1, %bb2
  %4 = load i8, i8* %_2, align 1, !range !0
  %5 = trunc i8 %4 to i1
...
define hidden i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h8c0a9238a98e1f48E"({ i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #1 {
start:
...
; Function Attrs: nounwind
define hidden void @"_ZN77_$LT$alloc..raw_vec..RawVec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hee22cb8020d23735E"({ i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nounwind
declare hidden { i32, i32 } @_ZN4core5alloc6layout6Layout25from_size_align_unchecked17ha4ecf1ce64bd0420E(i32, i32) unnamed_addr #1

; core::ptr::unique::Unique<T>::cast
; Function Attrs: inlinehint nounwind
declare dso_local nonnull i8* @"_ZN4core3ptr6unique15Unique$LT$T$GT$4cast17h304f1bf5e1dba8c6E"(i8* nonnull) unnamed_addr #1

; <T as core::convert::Into<U>>::into
; Function Attrs: nounwind
declare dso_local nonnull i8* @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hc3cde4d51d7fbaabE"(i8* nonnull) unnamed_addr #0
...
; Function Attrs: inlinehint nounwind
declare dso_local i8* @"_ZN4core3ptr6unique15Unique$LT$T$GT$6as_ptr17hd64e2c4a84f5e768E"(i8* nonnull) unnamed_addr #1

; <alloc::alloc::Global as core::alloc::Allocator>::deallocate
; Function Attrs: inlinehint nounwind
declare hidden void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17hdfb9630eebaac4e0E"(%"std::alloc::Global"* nonnull align 1, i8* nonnull, i32, i32) unnamed_addr #1
