...
define hidden { i8*, i32* } @_ZN4core3fmt10ArgumentV13new17h6ad3444321f4fb64E(i32* align 4 dereferenceable(4) %x, i1 (i32*, %"std::fmt::Formatter"*)* nonnull %f) unnamed_addr #0 {
start:
...
define hidden void @_ZN4core3fmt9Arguments6new_v117ha320c258b6750e5eE(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(24) %0, [0 x { [0 x i8]*, i32 }]* nonnull align 4 %pieces.0, i32 %pieces.1, [0 x { i8*, i32* }]* nonnull align 4 %args.0, i32 %args.1) unnamed_addr #1 {
start:
