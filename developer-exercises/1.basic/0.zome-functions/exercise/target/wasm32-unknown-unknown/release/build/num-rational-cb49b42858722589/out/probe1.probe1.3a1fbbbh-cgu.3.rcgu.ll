...
; Function Attrs: inlinehint nounwind
define hidden void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17hdfb9630eebaac4e0E"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i32 %0, i32 %1) unnamed_addr #0 {
start:
  %2 = alloca {}, align 1
  %layout = alloca { i32, i32 }, align 4
...
; Function Attrs: inlinehint nounwind
declare hidden i32 @_ZN4core5alloc6layout6Layout4size17h196e993eed8758b9E({ i32, i32 }* align 4 dereferenceable(8)) unnamed_addr #0

; core::alloc::layout::Layout::align
; Function Attrs: inlinehint nounwind
declare hidden i32 @_ZN4core5alloc6layout6Layout5align17hbcc811e62a84c0b9E({ i32, i32 }* align 4 dereferenceable(8)) unnamed_addr #0
...
; Function Attrs: inlinehint nounwind
declare dso_local i8* @"_ZN4core3ptr8non_null16NonNull$LT$T$GT$6as_ptr17h05eefda701561d98E"(i8* nonnull) unnamed_addr #0
