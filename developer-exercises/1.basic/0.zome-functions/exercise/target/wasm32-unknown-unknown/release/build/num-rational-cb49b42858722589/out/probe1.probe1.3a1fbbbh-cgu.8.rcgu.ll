...
; Function Attrs: nounwind
declare dso_local zeroext i1 @"_ZN4core3fmt3num3imp55_$LT$impl$u20$core..fmt..LowerExp$u20$for$u20$isize$GT$3fmt17h91af9448c5cf4a6fE"(i32* align 4 dereferenceable(4), %"std::fmt::Formatter"* align 4 dereferenceable(36)) unnamed_addr #0

; core::fmt::ArgumentV1::new
; Function Attrs: nounwind
declare dso_local { i8*, i32* } @_ZN4core3fmt10ArgumentV13new17h86dbc28c1afce37fE(i32* align 4 dereferenceable(4), i1 (i32*, %"std::fmt::Formatter"*)* nonnull) unnamed_addr #0

; core::fmt::Arguments::new_v1
; Function Attrs: inlinehint nounwind
declare hidden void @_ZN4core3fmt9Arguments6new_v117h4b4e506baac03a84E(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(24), [0 x { [0 x i8]*, i32 }]* nonnull align 4, i32, [0 x { i8*, i32* }]* nonnull align 4, i32) unnamed_addr #1

; alloc::fmt::format
; Function Attrs: nounwind
declare dso_local void @_ZN5alloc3fmt6format17hcd01b0e4dacf48e1E(%"std::string::String"* noalias nocapture sret(%"std::string::String") dereferenceable(12), %"std::fmt::Arguments"* noalias nocapture dereferenceable(24)) unnamed_addr #0
...
; Function Attrs: nounwind
declare dso_local void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h127cf0bfdf5e2fecE"(%"std::string::String"*) unnamed_addr #0
